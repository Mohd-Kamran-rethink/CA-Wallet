                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="zone" id="">
                                        ...
                                        @foreach ($zones as $item)
                                            <option {{ isset($agent) && $item->name == $agent->zone ? 'selected' : '' }}
                                                value="{{ $item->name }}">{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('zone')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="state" id="">
                                        ...
                                        @foreach ($states as $item)
                                            <option {{ isset($agent) && $item->name == $agent->state ? 'selected' : '' }}
                                                value="{{ $item->name }}">{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('state')
                            ...
                            <div class="col-xs-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="lead_type" id="">
                                        <option value="0">--Choose--</option>
                                        <option {{ isset($agent) && $agent->lead_type == 'Whats App' ? 'selected' : '' }}
                                            value="Whats App">Whats App</option>
                                        <option {{ isset($agent) && $agent->lead_type == 'Call' ? 'selected' : '' }}
                            ...
                            <div class="col-xs-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="agent_type" id="">
                                        <option value="0">--Choose--</option>
                                        <option {{ isset($agent) && $agent->agent_type == 'Retention' ? 'selected' : '' }}
                                            value="Retention">Retention</option>
                                        <option {{ isset($agent) && $agent->agent_type == 'Normal' ? 'selected' : '' }}
                                            value="Normal">Normal</option>
                                        <option {{ isset($agent) && $agent->agent_type == 'Both' ? 'selected' : '' }}
